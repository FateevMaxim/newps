                ...
                <div class="single-footer-item">
                    ...
                    <div class="footer-social">
                        <ul>
                            ...
                            <li><a href="https://www.youtube.com/channel/UCgO7IITrYAK-H_qkRjJqLXQ"><i class="fab fa-youtube"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="footer-bottom">
                    <ul>
                        ...
                        <li>Developed by <a href="https://redlines.tech" target="_blank">RedLines</a></li>
                    </ul>
                </div>
            </div>
        </div>
